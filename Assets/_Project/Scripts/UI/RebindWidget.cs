/// Adapted from the RebindActionUI sample provided by Unity in the InputSystem package
using System;
...
namespace Vanguard.UI
{
    ...
    /// </summary>
    public class RebindWidget : MonoBehaviour
    {
        /// <summary>
        ...
        {
            if (s_RebindWidgets == null)
                s_RebindWidgets = new List<RebindWidget>();
            s_RebindWidgets.Add(this);
            if (s_RebindWidgets.Count == 1)
        ...
        protected void OnDisable()
        {
            ...
            s_RebindWidgets.Remove(this);
            if (s_RebindWidgets.Count == 0)
            {
                s_RebindWidgets = null;
                InputSystem.onActionChange -= OnActionChange;
            }
        }
        ...
        private static void OnActionChange(object obj, InputActionChange change)
        {
            ...
            for (var i = 0; i < s_RebindWidgets.Count; ++i)
            {
                var component = s_RebindWidgets[i];
        ...
        private static List<RebindWidget> s_RebindWidgets;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<RebindWidget, string, string, string>
        {
        }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<RebindWidget, InputActionRebindingExtensions.RebindingOperation>
        {
        }
    }
}
