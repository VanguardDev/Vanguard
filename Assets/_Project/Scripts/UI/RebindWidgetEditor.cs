...
{
    /// <summary>
    /// A custom inspector for <see cref="RebindWidget"/> which provides a more convenient way for
    /// picking the binding which to rebind.
    /// </summary>
    [CustomEditor(typeof(RebindWidget))]
    public class RebindWidgetEditor : UnityEditor.Editor
    {
